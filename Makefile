...
build_app_jdk8: build_jdk8
	...
	docker cp ${JDK8}-build:/home/gradle/service/simpson-app/build/libs/$(ORIGIN_JAR_FILE) $(SERVICE_JAR_FILE).${JDK8}.jar
...
build_app_jdk7: build_jdk7
	...
	docker cp ${JDK7}-build:/home/gradle/service/simpson-app/build/libs/$(ORIGIN_JAR_FILE) $(SERVICE_JAR_FILE).${JDK7}.jar
...
module6:
	docker-compose -f $(DOCKER_COMPOSE_FILE) up --build jdk6-module \
